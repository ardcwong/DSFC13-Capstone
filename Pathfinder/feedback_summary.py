...
def score_table_show(scores):
    ...
    table_html = f"""
    <table class="styled-table" style="width: 100%; border-collapse: separate; border-spacing: 0; font-size: 16px; margin-top: 6px; border-radius: 5px; border: 1px solid #21AF8D; overflow: hidden;">
