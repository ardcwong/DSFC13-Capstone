...
if st.session_state.BeginAssessment == True:
    ...
    with col_main2:
        with st.expander(":blue-background[How it works]", expanded=st.session_state.BeginAssessment):
            ...
            **Eskwelabs' Bootcamp**: Ideal for those who prefer structured, guided learning with hands-on projects and community support. <br>
            **Self-Learning**: Best suited for independent learners who thrive on flexibility and self-paced study. <br>
