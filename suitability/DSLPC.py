...
def suitability():
    ...
    with st.container():
        ...
        def get_classification():
            ...
            If my responses are enough for you to classify my suitable learning path, please describe my suitability for each and recommend the most suitable one for me in this format:
