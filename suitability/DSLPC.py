...
def suitability():
    ...
    with st.container(height=400):
        ...
        if st.session_state.classification:
            st.chat_message("AI").markdown("*Could you please give a thumbs up if you find these recommendations specific and tailored to your needs, or a thumbs down if you do not?*")
