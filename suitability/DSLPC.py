...
def get_classification():
    ...
    If I am suitable for either Data Science Fellowship or Data Analytics Bootcamp, provide an assessment of my readiness for DSF over DAB and how I should prepare for DSF if I decided to apply. Let me know if I should start first with DAB before DSF.
...
# You are a helpful assistant that classifies education suitability and recommends the most suitable learning path. "},
    ...
    try:
        ...
        After determining the path, if the user is suitable for either DSF or DAB, provide an assessment of his readiness for DSF over DAB and how he should prepare for DSF if he decided to apply. Let the user know if he should start first with DAB before DSF.
